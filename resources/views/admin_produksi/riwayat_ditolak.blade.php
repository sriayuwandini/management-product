    ...
    <div class="py-8 px-6 lg:px-12">
        <div class="text-gray-500 py-2 bg-white rounded-xl shadow-md mb-4">
            <div class="p-4 flex justify-between items-center">
                <h5 class="font-semibold text-gray-700">❌ Riwayat Pengajuan Ditolak</h5>
        ...
        @forelse ($users as $user)
            ...
            <div class="modal fade" id="modalDitolak{{ $user->id }}" tabindex="-1" aria-labelledby="modalLabel{{ $user->id }}" aria-hidden="true">
                <div class="modal-dialog modal-xl modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header bg-gray-100">
                            <h5 class="modal-title font-semibold" id="modalLabel{{ $user->id }}">
                                Detail Produk Ditolak — {{ $user->name }}
                            </h5>
